...
{
	[System.Serializable]
	public class CraftingDataRow : IGoogle2uRow
	{
		public int _ID;
	...
	public sealed class CraftingData : IGoogle2uDB
	{
		public enum rowIds {
			Tree_Lumber
		};
		...
		public System.Collections.Generic.List<CraftingDataRow> Rows = new System.Collections.Generic.List<CraftingDataRow>();
		...
		public CraftingDataRow GetRow(rowIds in_RowID)
		{
			CraftingDataRow ret = null;
			try
			{
				ret = Rows[(int)in_RowID];
			}
		...
		public CraftingDataRow GetRow(string in_RowString)
		{
			CraftingDataRow ret = null;
			try
			{
