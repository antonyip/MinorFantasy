...
{
	[System.Serializable]
	public class EquipmentDataRow : IGoogle2uRow
	{
		public int _ID;
	...
	public sealed class EquipmentData : IGoogle2uDB
	{
		...
		public EquipmentDataRow GetRow(rowIds in_RowID)
		{
			EquipmentDataRow ret = null;
			try
			{
				ret = Rows[(int)in_RowID];
			}
		...
		public EquipmentDataRow GetRow(string in_RowString)
		{
			EquipmentDataRow ret = null;
			try
			{
