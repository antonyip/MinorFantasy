...
namespace AntTool
{
  ...
  public class HeroesData
  {
    private HeroesData()
    {
      ...
      Rows.Add(new HeroesDataRow("H_1","Sword Man",1,"M","",1050,100,500,10,150,5,120,4,110,2,130,3,100,100,100,10,10,60,10,60,10,50,10,50,10,50,10,50,50,50,50,50,50,10,10,10,10,10,10,"1=6=7=8=9","Human1","Swordman_Casting","Swordman_Casting","HeroFace_1","TANK","NONE","NONE",50,10,""));
